  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      floatingActionButton: GestureDetector(
        onTap: (){
          Get.to(RegisterFaceForm(), transition: Transition.rightToLeft, duration: 300.milliseconds);
        },
        child: Container(
          width: 60,
          height: 60,
          ...
          child: Column(
            ...
            children: [
                       ...
                       margin: EdgeInsets.only(left: 10),
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            Text("I am David!",style: TextStyle(fontFamily: 'man-sb',fontSize: 25,color: Colors.white, letterSpacing: 1),)
                          ],
                        ),
                      ),
                      SizedBox(height: 15,),
             ...
             Container(
              width: w,
              height: 220,
               child: Row(// spacing between rows
                       children: [
                         GestureDetector(
                          onTap: (){
                            Get.to(ImageCapture());
                          },
                          child: featureCard(w, h, Color.fromARGB(255, 255, 153, 98), "Find Face", "assets/icons/face.png", 294,"Fetch Student details just by taking a snap of the student")),
                         GestureDetector(
                          onTap: (){
                            Get.to(Speech(),transition: Transition.rightToLeft, duration: 300.milliseconds);
                          },
                          child: featureCard(w, h, Color.fromARGB(255, 189, 244, 118), "Transcribe Lecture", "assets/icons/voice.png", 10, "Transcribe lectures converted into pdf by recording the live lecture from voice")),
                       ],
                     ),
             ...
             Padding(
               ...
               child: Text("Your Transcribes", style: TextStyle(fontFamily: 'man-r', fontSize: 24, color: Colors.white, fontWeight: FontWeight.bold),),
             ),
             Container(
              ...
              child: ListView.builder(
                itemCount: transcribesDesc.length,
                itemBuilder: (context, index) {
                  return transcribes(transcribesDesc[index], links[index]);
                },
      ...
      child: Column(
        ...
        children: [
              Column(
                ...
                children: [
                  Row(
                    mainAxisAlignment: MainAxisAlignment.spaceBetween,
                    children: [
                      Text(className, style: const TextStyle(fontFamily: 'man-r',fontSize: 22,color: Color.fromARGB(255,35,37,49),fontWeight: FontWeight.bold),),
                      Text(period, style: const TextStyle(fontFamily: 'man-l',fontSize: 12,color: Color.fromARGB(255, 0, 0, 0)),),
                    ],
                  ),
                  Text(subject, style: const TextStyle(fontFamily: 'man-l',fontSize: 14,color: Color.fromARGB(255, 0, 0, 0)),)
                ],
              ),
          ...
          Row(
            ...
            Row(
              children: [
                Image.asset("assets/icons/attendance.png",width: 40,),
                SizedBox(width: 10,),
                Text("72", style: TextStyle(fontFamily: 'man-r',fontSize: 40),)
              ],
            ),
              const Icon(Icons.arrow_forward_ios,size: 20,color: const Color.fromARGB(255, 0, 0, 0),)
            ],
          )
        ],
      ),
            ...
            Row(
              children: [
                Container(
                  width: 110,
                  height: 50,
                  child: Text(title, style: TextStyle(fontFamily: 'man-r',color: Colors.black, fontSize: 18, fontWeight: FontWeight.bold),)),
                Container(
                  width: 40,
                  height: 40,
                  decoration: BoxDecoration(
                  ...
                  child: Center(
                    child: Image.asset('assets/icons/arrow.png', width: 20,),
                  ),)
              ],
            ...
            Container(
              ...
              child: Row(
                ...
                children: [
                  ...
                  SizedBox(width: 10,),
                  Text(value.toString(), style: TextStyle(fontFamily: 'man-r', fontSize: 20,),)
                ],
              ),
            ),
            SizedBox(height: 20,),
            Text(desc,style: TextStyle(fontFamily: 'man-r',fontSize: 10 ),),
          ],
        ),
      )
  );
          ...
          Row(
            children: [
              Container(
                ...
                child: Center(
                  child: Icon(Icons.mic_none_outlined, size: 25,color: Colors.white,),
                ),
              ),
              SizedBox(width: 15,),
              SizedBox(width: 200,child: Text(desc, style: TextStyle(fontSize: 14, color: Colors.white, fontFamily: 'man-r'),)),
              SizedBox(width: 70,),
              Image.asset("assets/icons/dots.png", color: Colors.white,width: 20,)
