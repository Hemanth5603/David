...
import 'package:prototype/student/views/tabs/auth/student_login.dart';
              ...
              child: Column(
                ...
                children: [
                  const Padding(
                    ...
                    child: Text("Welcome !",style: TextStyle(fontFamily: 'man-b',fontSize: 35,fontWeight: FontWeight.bold)),
                  ),
                  const Padding(
                    padding: EdgeInsets.only(left:10.0),
                    child: Text("Create Your Account",style: TextStyle(fontFamily: 'man-sb',fontSize: 30,fontWeight: FontWeight.bold)),
                  ),
                      ...
                      child: Row(
                        children: [
                          SizedBox(
                            ...
                            child:  Center(
                              child: TextField(
                                controller: userController.rollNumber, // Replace email controller with rollNumber controller
                                keyboardType: TextInputType.text, // Use TextInputType.text for alphanumeric roll numbers
                                textAlignVertical: TextAlignVertical.bottom,
                                style: const TextStyle(fontFamily: 'man-r'),
                                decoration: InputDecoration(
                                  hintText: "Roll Number", // Change hint text to Roll Number
                                  hintStyle: TextStyle(color: Color.fromARGB(255, 106, 106, 106)),
                                  border: UnderlineInputBorder(
                                    borderSide: BorderSide(color: Color.fromARGB(255, 0, 0, 0), width: 5),
                                  ),
                  ...
                  Row(
                    ...
                    children: [
                      ...
                      GestureDetector(
                        ...
                        onTap: (){
                         Get.to(const StudentLogin(),transition: Transition.rightToLeft,duration: 300.milliseconds);
                        },
                      )
